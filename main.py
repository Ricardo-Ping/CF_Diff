...
n_hop = 2  # The number of hops neighbors, e.g. n_hop=3 means three hops neighbors are taken into account
...
multi_hop = data_utils.DiffusionData_sec_hop(torch.FloatTensor(train_data.A))
train_loader_sec_hop = DataLoader(multi_hop, batch_size=args.batch_size, pin_memory=True, shuffle=True, num_workers=0,
                                  worker_init_fn=worker_init_fn)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % 5 == 0:
            ...
            if valid_results[1][1] > best_recall:  # recall@20 as selection
                ...
                torch.save(model,
                           '{}{}_lr{}_wd{}_bs{}_emb{}_{}_steps{}_scale{}_min{}_max{}_sample{}_reweight{}_{}.pth' \
                           .format(args.save_path, args.dataset, args.lr, args.weight_decay, args.batch_size,
                                   args.emb_size, args.mean_type, args.steps, args.noise_scale, args.noise_min, args.noise_max, args.sampling_steps,
